...
| `src/js/scoring.js` | `scoreWord`, `isBloom`, `computeRankThresholds`, `getRank`, `formatShareText`. |
...
| `src/js/app.js` | UI controller — DOM manipulation, event binding, modals. IIFE, depends on all above. |
